#include "stdafx.h"
#include "..\Public\Effect_Boss_UFO_Flying_Particle_Flow.h"
#include "DataStorage.h"
#include "UFO.h"

CEffect_Boss_UFO_Flying_Particle_Flow::CEffect_Boss_UFO_Flying_Particle_Flow(ID3D11Device * pDevice, ID3D11DeviceContext * pDeviceContext)
	: CInGameEffect(pDevice, pDeviceContext)
{
}

CEffect_Boss_UFO_Flying_Particle_Flow::CEffect_Boss_UFO_Flying_Particle_Flow(const CEffect_Boss_UFO_Flying_Particle_Flow & rhs)
	: CInGameEffect(rhs)
{
}

HRESULT CEffect_Boss_UFO_Flying_Particle_Flow::NativeConstruct_Prototype(void * pArg)
{
...
HRESULT CEffect_Boss_UFO_Flying_Particle_Flow::NativeConstruct(void * pArg)
{
	if (nullptr != pArg)
...
_int CEffect_Boss_UFO_Flying_Particle_Flow::Tick(_double TimeDelta)
{
...
_int CEffect_Boss_UFO_Flying_Particle_Flow::Late_Tick(_double TimeDelta)
{
	return m_pRendererCom->Add_GameObject_ToRenderGroup(RENDER_GROUP::RENDER_EFFECT, this);
}

HRESULT CEffect_Boss_UFO_Flying_Particle_Flow::Render(RENDER_GROUP::Enum eGroup)
{
...
void CEffect_Boss_UFO_Flying_Particle_Flow::Check_Instance(_double TimeDelta)
{
...
void CEffect_Boss_UFO_Flying_Particle_Flow::Instance_Size(_float TimeDelta, _int iIndex)
{
}
...
void CEffect_Boss_UFO_Flying_Particle_Flow::Reset_Instance(_double TimeDelta, _fmatrix ParentMatrix, _int iIndex)
{
...
void CEffect_Boss_UFO_Flying_Particle_Flow::Check_ParentMatrix()
{
...
HRESULT CEffect_Boss_UFO_Flying_Particle_Flow::Ready_InstanceBuffer()
{
...
CEffect_Boss_UFO_Flying_Particle_Flow * CEffect_Boss_UFO_Flying_Particle_Flow::Create(ID3D11Device * pDevice, ID3D11DeviceContext * pDeviceContext, void * pArg)
{
	CEffect_Boss_UFO_Flying_Particle_Flow*	pInstance = new CEffect_Boss_UFO_Flying_Particle_Flow(pDevice, pDeviceContext);
	if (FAILED(pInstance->NativeConstruct_Prototype(pArg)))
	{
		MSG_BOX("Failed to Create Instance - CEffect_Boss_UFO_Flying_Particle_Flow");
		Safe_Release(pInstance);
	}
	return pInstance;
}

CGameObject * CEffect_Boss_UFO_Flying_Particle_Flow::Clone_GameObject(void * pArg)
{
	CEffect_Boss_UFO_Flying_Particle_Flow* pInstance = new CEffect_Boss_UFO_Flying_Particle_Flow(*this);
	if (FAILED(pInstance->NativeConstruct(pArg)))
	{
		MSG_BOX("Failed to Clone Instance - CEffect_Boss_UFO_Flying_Particle_Flow");
		Safe_Release(pInstance);
	}
	return pInstance;
}

void CEffect_Boss_UFO_Flying_Particle_Flow::Free()
{
