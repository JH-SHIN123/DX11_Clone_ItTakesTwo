#include "stdafx.h"
#include "..\Public\Effect_CS_MoonBaboon_FallDown_Smoke.h"
#include "DataStorage.h"
#include "MoonBaboon.h"

CEffect_CS_MoonBaboon_FallDown_Smoke::CEffect_CS_MoonBaboon_FallDown_Smoke(ID3D11Device * pDevice, ID3D11DeviceContext * pDeviceContext)
	: CInGameEffect(pDevice, pDeviceContext)
{
}

CEffect_CS_MoonBaboon_FallDown_Smoke::CEffect_CS_MoonBaboon_FallDown_Smoke(const CEffect_CS_MoonBaboon_FallDown_Smoke & rhs)
	: CInGameEffect(rhs)
{
}

HRESULT CEffect_CS_MoonBaboon_FallDown_Smoke::NativeConstruct_Prototype(void * pArg)
{
...
HRESULT CEffect_CS_MoonBaboon_FallDown_Smoke::NativeConstruct(void * pArg)
{
	if (nullptr != pArg)
...
_int CEffect_CS_MoonBaboon_FallDown_Smoke::Tick(_double TimeDelta)
{
...
_int CEffect_CS_MoonBaboon_FallDown_Smoke::Late_Tick(_double TimeDelta)
{
	return m_pRendererCom->Add_GameObject_ToRenderGroup(RENDER_GROUP::RENDER_EFFECT_NO_BLUR, this);
}

HRESULT CEffect_CS_MoonBaboon_FallDown_Smoke::Render(RENDER_GROUP::Enum eGroup)
{
...
void CEffect_CS_MoonBaboon_FallDown_Smoke::Set_Pos(_fvector vPos)
{
	m_pTransformCom->Set_State(CTransform::STATE_POSITION, vPos);
}

void CEffect_CS_MoonBaboon_FallDown_Smoke::Check_Instance(_double TimeDelta)
{
	_float4 vMyPos;
	...
	{
		m_pInstanceBuffer_STT[iIndex].fTime -= (_float)TimeDelta * 0.3f;
...
void CEffect_CS_MoonBaboon_FallDown_Smoke::Check_TargetMatrix()
{
...
void CEffect_CS_MoonBaboon_FallDown_Smoke::Instance_Size(_float TimeDelta, _int iIndex)
{
	m_pInstanceBuffer_STT[iIndex].vSize.x += TimeDelta * 2.5f;
	m_pInstanceBuffer_STT[iIndex].vSize.y += TimeDelta * 2.5f;
}

void CEffect_CS_MoonBaboon_FallDown_Smoke::Instance_Pos(_float TimeDelta, _int iIndex)
{
}

void CEffect_CS_MoonBaboon_FallDown_Smoke::Instance_UV(_float TimeDelta, _int iIndex)
{
...
void CEffect_CS_MoonBaboon_FallDown_Smoke::Reset_Instance(_double TimeDelta, _float4 vPos, _int iIndex)
{
...
HRESULT CEffect_CS_MoonBaboon_FallDown_Smoke::Ready_InstanceBuffer()
{
...
CEffect_CS_MoonBaboon_FallDown_Smoke * CEffect_CS_MoonBaboon_FallDown_Smoke::Create(ID3D11Device * pDevice, ID3D11DeviceContext * pDeviceContext, void * pArg)
{
	CEffect_CS_MoonBaboon_FallDown_Smoke*	pInstance = new CEffect_CS_MoonBaboon_FallDown_Smoke(pDevice, pDeviceContext);
	if (FAILED(pInstance->NativeConstruct_Prototype(pArg)))
	{
		MSG_BOX("Failed to Create Instance - CEffect_CS_MoonBaboon_FallDown_Smoke");
		Safe_Release(pInstance);
	}
	return pInstance;
}

CGameObject * CEffect_CS_MoonBaboon_FallDown_Smoke::Clone_GameObject(void * pArg)
{
	CEffect_CS_MoonBaboon_FallDown_Smoke* pInstance = new CEffect_CS_MoonBaboon_FallDown_Smoke(*this);
	if (FAILED(pInstance->NativeConstruct(pArg)))
	{
		MSG_BOX("Failed to Clone Instance - CEffect_CS_MoonBaboon_FallDown_Smoke");
		Safe_Release(pInstance);
	}
	return pInstance;
}

void CEffect_CS_MoonBaboon_FallDown_Smoke::Free()
{
