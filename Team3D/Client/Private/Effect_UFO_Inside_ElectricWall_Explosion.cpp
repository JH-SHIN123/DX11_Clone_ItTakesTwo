#include "stdafx.h"
#include "..\Public\Effect_UFO_Inside_ElectricWall_Explosion.h"

CEffect_UFO_Inside_ElectricWall_Explosion::CEffect_UFO_Inside_ElectricWall_Explosion(ID3D11Device * pDevice, ID3D11DeviceContext * pDeviceContext)
	: CInGameEffect(pDevice, pDeviceContext)
{
}

CEffect_UFO_Inside_ElectricWall_Explosion::CEffect_UFO_Inside_ElectricWall_Explosion(const CEffect_UFO_Inside_ElectricWall_Explosion & rhs)
	: CInGameEffect(rhs)
{
}

HRESULT CEffect_UFO_Inside_ElectricWall_Explosion::NativeConstruct_Prototype(void * pArg)
{
...
HRESULT CEffect_UFO_Inside_ElectricWall_Explosion::NativeConstruct(void * pArg)
{
	if (nullptr != pArg)
...
_int CEffect_UFO_Inside_ElectricWall_Explosion::Tick(_double TimeDelta)
{
...
_int CEffect_UFO_Inside_ElectricWall_Explosion::Late_Tick(_double TimeDelta)
{
	return m_pRendererCom->Add_GameObject_ToRenderGroup(RENDER_GROUP::RENDER_EFFECT, this);
}

HRESULT CEffect_UFO_Inside_ElectricWall_Explosion::Render(RENDER_GROUP::Enum eGroup)
{
...
void CEffect_UFO_Inside_ElectricWall_Explosion::Check_Instance(_double TimeDelta)
{
	...
	for (_int iIndex = 0; iIndex < m_EffectDesc_Prototype.iInstanceCount; ++iIndex)
	{
		...
		m_pInstanceBuffer_STT[iIndex].vSize.y -= (_float)TimeDelta * 0.08f;
...
void CEffect_UFO_Inside_ElectricWall_Explosion::Instance_Size(_float TimeDelta, _int iIndex)
{
}

void CEffect_UFO_Inside_ElectricWall_Explosion::Instance_Pos(_float TimeDelta, _int iIndex)
{
...
void CEffect_UFO_Inside_ElectricWall_Explosion::Instance_UV(_float TimeDelta, _int iIndex)
{
}

void CEffect_UFO_Inside_ElectricWall_Explosion::Reset_Instance(_double TimeDelta, _fmatrix ParentMatrix, _int iIndex)
{
...
HRESULT CEffect_UFO_Inside_ElectricWall_Explosion::Ready_InstanceBuffer()
{
...
CEffect_UFO_Inside_ElectricWall_Explosion * CEffect_UFO_Inside_ElectricWall_Explosion::Create(ID3D11Device * pDevice, ID3D11DeviceContext * pDeviceContext, void * pArg)
{
	CEffect_UFO_Inside_ElectricWall_Explosion*	pInstance = new CEffect_UFO_Inside_ElectricWall_Explosion(pDevice, pDeviceContext);
	if (FAILED(pInstance->NativeConstruct_Prototype(pArg)))
	{
		MSG_BOX("Failed to Create Instance - CEffect_UFO_Inside_ElectricWall_Explosion");
		Safe_Release(pInstance);
	}
	return pInstance;
}

CGameObject * CEffect_UFO_Inside_ElectricWall_Explosion::Clone_GameObject(void * pArg)
{
	CEffect_UFO_Inside_ElectricWall_Explosion* pInstance = new CEffect_UFO_Inside_ElectricWall_Explosion(*this);
	if (FAILED(pInstance->NativeConstruct(pArg)))
	{
		MSG_BOX("Failed to Clone Instance - CEffect_UFO_Inside_ElectricWall_Explosion");
		Safe_Release(pInstance);
	}
	return pInstance;
}

void CEffect_UFO_Inside_ElectricWall_Explosion::Free()
{
