#include "stdafx.h"
#include "..\Public\Effect_Boss_Core_Smoke.h"

CEffect_Boss_Core_Smoke::CEffect_Boss_Core_Smoke(ID3D11Device * pDevice, ID3D11DeviceContext * pDeviceContext)
	: CInGameEffect(pDevice, pDeviceContext)
{
}

CEffect_Boss_Core_Smoke::CEffect_Boss_Core_Smoke(const CEffect_Boss_Core_Smoke & rhs)
	: CInGameEffect(rhs)
{
}

HRESULT CEffect_Boss_Core_Smoke::NativeConstruct_Prototype(void * pArg)
{
...
HRESULT CEffect_Boss_Core_Smoke::NativeConstruct(void * pArg)
{
	if (nullptr != pArg)
...
_int CEffect_Boss_Core_Smoke::Tick(_double TimeDelta)
{
...
_int CEffect_Boss_Core_Smoke::Late_Tick(_double TimeDelta)
{
	return m_pRendererCom->Add_GameObject_ToRenderGroup(RENDER_GROUP::RENDER_EFFECT, this);
}

HRESULT CEffect_Boss_Core_Smoke::Render(RENDER_GROUP::Enum eGroup)
{
...
void CEffect_Boss_Core_Smoke::Instance_Size(_float TimeDelta, _int iIndex)
{
}

void CEffect_Boss_Core_Smoke::Instance_Pos(_float TimeDelta, _int iIndex)
{
...
void CEffect_Boss_Core_Smoke::Instance_UV(_float TimeDelta, _int iIndex)
{
...
HRESULT CEffect_Boss_Core_Smoke::Ready_InstanceBuffer()
{
	...
	for (_int iIndex = 0; iIndex < iInstanceCount; ++iIndex)
	{
		...
		if (0.f <= m_pInstanceBiffer_Dir[iIndex].y)
			m_pInstanceBiffer_Dir[iIndex].y *= -1.f;
	}

	return S_OK;
}

_float2 CEffect_Boss_Core_Smoke::Get_Rand_Size()
{
...
void CEffect_Boss_Core_Smoke::Check_InstanceBuffer(_double TimeDelta)
{
	_int iInstanceCount = m_EffectDesc_Prototype.iInstanceCount;
	for (_int iIndex = 0; iIndex < iInstanceCount; ++iIndex)
	{
...
CEffect_Boss_Core_Smoke * CEffect_Boss_Core_Smoke::Create(ID3D11Device * pDevice, ID3D11DeviceContext * pDeviceContext, void * pArg)
{
	CEffect_Boss_Core_Smoke*	pInstance = new CEffect_Boss_Core_Smoke(pDevice, pDeviceContext);
	if (FAILED(pInstance->NativeConstruct_Prototype(pArg)))
	{
		MSG_BOX("Failed to Create Instance - CEffect_Boss_Core_Smoke");
		Safe_Release(pInstance);
	}
	return pInstance;
}

CGameObject * CEffect_Boss_Core_Smoke::Clone_GameObject(void * pArg)
{
	CEffect_Boss_Core_Smoke* pInstance = new CEffect_Boss_Core_Smoke(*this);
	if (FAILED(pInstance->NativeConstruct(pArg)))
	{
		MSG_BOX("Failed to Clone Instance - CEffect_Boss_Core_Smoke");
		Safe_Release(pInstance);
	}
	return pInstance;
}

void CEffect_Boss_Core_Smoke::Free()
{
