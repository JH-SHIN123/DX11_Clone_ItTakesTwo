...
CEffect_Boss_Missile_Smoke::CEffect_Boss_Missile_Smoke(const CEffect_Boss_Missile_Smoke & rhs)
	: CInGameEffect(rhs)
{
}
...
HRESULT CEffect_Boss_Missile_Smoke::NativeConstruct(void * pArg)
{
	if (nullptr != pArg)
...
void CEffect_Boss_Missile_Smoke::Set_Pos(_fvector vPos)
{
	m_pTransformCom->Set_State(CTransform::STATE_POSITION, vPos);
}

void CEffect_Boss_Missile_Smoke::Check_Instance(_double TimeDelta)
{
	_float4 vMyPos;
...
void CEffect_Boss_Missile_Smoke::Instance_Size(_float TimeDelta, _int iIndex)
{
...
void CEffect_Boss_Missile_Smoke::Instance_Pos(_float TimeDelta, _int iIndex)
{
	m_pInstanceBuffer_STT[iIndex].vPosition.y += TimeDelta * m_fSize_Power;
}

void CEffect_Boss_Missile_Smoke::Instance_UV(_float TimeDelta, _int iIndex)
{
...
void CEffect_Boss_Missile_Smoke::Reset_Instance(_double TimeDelta, _float4 vPos, _int iIndex)
{
...
HRESULT CEffect_Boss_Missile_Smoke::Ready_InstanceBuffer()
{
...
CEffect_Boss_Missile_Smoke * CEffect_Boss_Missile_Smoke::Create(ID3D11Device * pDevice, ID3D11DeviceContext * pDeviceContext, void * pArg)
{
	CEffect_Boss_Missile_Smoke*	pInstance = new CEffect_Boss_Missile_Smoke(pDevice, pDeviceContext);
	if (FAILED(pInstance->NativeConstruct_Prototype(pArg)))
	{
		MSG_BOX("Failed to Create Instance - CEffect_Boss_Missile_Smoke");
		Safe_Release(pInstance);
	}
	return pInstance;
}

CGameObject * CEffect_Boss_Missile_Smoke::Clone_GameObject(void * pArg)
{
	CEffect_Boss_Missile_Smoke* pInstance = new CEffect_Boss_Missile_Smoke(*this);
	if (FAILED(pInstance->NativeConstruct(pArg)))
	{
		MSG_BOX("Failed to Clone Instance - CEffect_Boss_Missile_Smoke");
		Safe_Release(pInstance);
	}
	return pInstance;
}

void CEffect_Boss_Missile_Smoke::Free()
{
