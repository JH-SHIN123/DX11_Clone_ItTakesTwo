...
#include "Effect_Gravity_Umbrella.h"
#pragma endregion
...
HRESULT CEffect_Generator::Create_Prototype(_uint iLevelIndex, const _tchar * pPrototypeName, ID3D11Device* pDevice, ID3D11DeviceContext* pDeviceContext, EFFECT_DESC_PROTO* pData)
{
	...
	// 3D Effect
		...
		pInstance->Add_GameObject_Prototype(iLevelIndex, L"GameObject_3D_Umbrella_Pipe", CEffect_Gravity_Umbrella::Create(pDevice, pDeviceContext, pData));
