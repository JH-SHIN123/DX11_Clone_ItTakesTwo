...
HRESULT CEffect_UFO_Inside_PressWall_Smoke::NativeConstruct(void * pArg)
{
	...
	FAILED_CHECK_RETURN(CGameObject::Add_Component(Level::LEVEL_STAGE, TEXT("Component_Texture_Smoke_Puff_02"), TEXT("Com_Texture_Second"), (CComponent**)&m_pTexturesCom_Second), E_FAIL);
