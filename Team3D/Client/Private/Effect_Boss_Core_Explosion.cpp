...
HRESULT CEffect_Boss_Core_Explosion::Ready_InstanceBuffer()
{
...
_float2 CEffect_Boss_Core_Explosion::Get_Rand_Size()
{
...
void CEffect_Boss_Core_Explosion::Check_InstanceBuffer(_double TimeDelta)
{
	_int iInstanceCount = m_EffectDesc_Prototype.iInstanceCount;
	for (_int iIndex = 0; iIndex < iInstanceCount; ++iIndex)
	{
