...
HRESULT CVolumeObject::NativeConstruct(void* pArg)
{
	...
	FAILED_CHECK_RETURN(CGameObject::Add_Component(Level::LEVEL_STAGE, TEXT("Component_Model_GeoCube"), TEXT("Com_Model"), (CComponent**)&m_pModelCom), E_FAIL);

	m_pTransformCom->Set_Scale(XMVectorSet(15.f, 15.f, 15.f, 0.f));
	m_pTransformCom->Set_State(CTransform::STATE_POSITION, XMVectorSet(59.f, 0.f, 5.f, 1.f));
