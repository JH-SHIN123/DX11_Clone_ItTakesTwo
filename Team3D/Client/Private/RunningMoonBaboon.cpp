...
_int CRunningMoonBaboon::Tick(_double dTimeDelta)
{
	...
	m_pGameInstance->Raycast(MH_PxVec3(m_pTransformCom->Get_State(CTransform::STATE_POSITION)), MH_PxVec3(vRayDir), 40.f, m_RaycastBuffer, PxHitFlag::eDISTANCE | PxHitFlag::ePOSITION | PxHitFlag::eNORMAL);
