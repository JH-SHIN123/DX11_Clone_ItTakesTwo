#include "stdafx.h"
#include "..\Public\Effect_Boss_BrokenLaser_Particle.h"
#include "DataStorage.h"
#include "UFO.h"

CEffect_Boss_BrokenLaser_Particle::CEffect_Boss_BrokenLaser_Particle(ID3D11Device * pDevice, ID3D11DeviceContext * pDeviceContext)
	: CInGameEffect(pDevice, pDeviceContext)
{
}

CEffect_Boss_BrokenLaser_Particle::CEffect_Boss_BrokenLaser_Particle(const CEffect_Boss_BrokenLaser_Particle & rhs)
	: CInGameEffect(rhs)
{
}

HRESULT CEffect_Boss_BrokenLaser_Particle::NativeConstruct_Prototype(void * pArg)
{
...
HRESULT CEffect_Boss_BrokenLaser_Particle::NativeConstruct(void * pArg)
{
	if (nullptr != pArg)
...
_int CEffect_Boss_BrokenLaser_Particle::Tick(_double TimeDelta)
{
...
_int CEffect_Boss_BrokenLaser_Particle::Late_Tick(_double TimeDelta)
{
	return m_pRendererCom->Add_GameObject_ToRenderGroup(RENDER_GROUP::RENDER_EFFECT, this);
}

HRESULT CEffect_Boss_BrokenLaser_Particle::Render(RENDER_GROUP::Enum eGroup)
{
...
void CEffect_Boss_BrokenLaser_Particle::Check_Instance(_double TimeDelta)
{
...
void CEffect_Boss_BrokenLaser_Particle::Check_TargetMatrix()
{
...
void CEffect_Boss_BrokenLaser_Particle::Instance_Size(_float TimeDelta, _int iIndex)
{
...
void CEffect_Boss_BrokenLaser_Particle::Instance_UV(_float TimeDelta, _int iIndex)
{
}

void CEffect_Boss_BrokenLaser_Particle::Reset_Instance(_double TimeDelta, _fmatrix ParentMatrix, _int iIndex)
{
}

HRESULT CEffect_Boss_BrokenLaser_Particle::Ready_InstanceBuffer()
{
	...
	for (_int iIndex = 0; iIndex < iInstanceCount; ++iIndex)
	{
		...
		if (m_pInstanceBuffer_Dir[iIndex].y < 0.f) m_pInstanceBuffer_Dir[iIndex].y *= -1.f;
	}

	return S_OK;
}

CEffect_Boss_BrokenLaser_Particle * CEffect_Boss_BrokenLaser_Particle::Create(ID3D11Device * pDevice, ID3D11DeviceContext * pDeviceContext, void * pArg)
{
	CEffect_Boss_BrokenLaser_Particle*	pInstance = new CEffect_Boss_BrokenLaser_Particle(pDevice, pDeviceContext);
	if (FAILED(pInstance->NativeConstruct_Prototype(pArg)))
	{
		MSG_BOX("Failed to Create Instance - CEffect_Boss_BrokenLaser_Particle");
		Safe_Release(pInstance);
	}
	return pInstance;
}

CGameObject * CEffect_Boss_BrokenLaser_Particle::Clone_GameObject(void * pArg)
{
	CEffect_Boss_BrokenLaser_Particle* pInstance = new CEffect_Boss_BrokenLaser_Particle(*this);
	if (FAILED(pInstance->NativeConstruct(pArg)))
	{
		MSG_BOX("Failed to Clone Instance - CEffect_Boss_BrokenLaser_Particle");
		Safe_Release(pInstance);
	}
	return pInstance;
}

void CEffect_Boss_BrokenLaser_Particle::Free()
{
