...
BEGIN(Client)
class CEffect_Player_Rail_Particle final : public CInGameEffect
{
private:
	explicit CEffect_Player_Rail_Particle(ID3D11Device* pDevice, ID3D11DeviceContext* pDeviceContext);
	explicit CEffect_Player_Rail_Particle(const CEffect_Player_Rail_Particle& rhs);
	virtual ~CEffect_Player_Rail_Particle() = default; public:
