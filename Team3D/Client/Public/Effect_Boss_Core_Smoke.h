...
BEGIN(Client)
class CEffect_Boss_Core_Smoke final: public CInGameEffect
{
private:
	explicit CEffect_Boss_Core_Smoke(ID3D11Device* pDevice, ID3D11DeviceContext* pDeviceContext);
	explicit CEffect_Boss_Core_Smoke(const CEffect_Boss_Core_Smoke& rhs);
	virtual ~CEffect_Boss_Core_Smoke() = default; public:
