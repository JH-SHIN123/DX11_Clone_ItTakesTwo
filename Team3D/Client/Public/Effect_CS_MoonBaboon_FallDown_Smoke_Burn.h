...
BEGIN(Client)
class CEffect_CS_MoonBaboon_FallDown_Smoke_Burn final : public CInGameEffect
{
private:
	explicit CEffect_CS_MoonBaboon_FallDown_Smoke_Burn(ID3D11Device* pDevice, ID3D11DeviceContext* pDeviceContext);
	explicit CEffect_CS_MoonBaboon_FallDown_Smoke_Burn(const CEffect_CS_MoonBaboon_FallDown_Smoke_Burn& rhs);
	virtual ~CEffect_CS_MoonBaboon_FallDown_Smoke_Burn() = default; public:
...
public:
	static CEffect_CS_MoonBaboon_FallDown_Smoke_Burn* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pDeviceContext, void* pArg);
