...
BEGIN(Client)
class CEffect_Boss_Gravitational_Bomb_Explosion final : public CInGameEffect
{
private:
	explicit CEffect_Boss_Gravitational_Bomb_Explosion(ID3D11Device* pDevice, ID3D11DeviceContext* pDeviceContext);
	explicit CEffect_Boss_Gravitational_Bomb_Explosion(const CEffect_Boss_Gravitational_Bomb_Explosion& rhs);
	virtual ~CEffect_Boss_Gravitational_Bomb_Explosion() = default; public:
...
private:
	...
	const _float2 m_vDefaultSize = { 0.25f, 0.7f };



public:
	static CEffect_Boss_Gravitational_Bomb_Explosion* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pDeviceContext, void* pArg);
