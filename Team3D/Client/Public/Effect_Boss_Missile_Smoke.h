...
BEGIN(Client)
class CEffect_Boss_Missile_Smoke final : public CInGameEffect
{
private:
	explicit CEffect_Boss_Missile_Smoke(ID3D11Device* pDevice, ID3D11DeviceContext* pDeviceContext);
	explicit CEffect_Boss_Missile_Smoke(const CEffect_Boss_Missile_Smoke& rhs);
	virtual ~CEffect_Boss_Missile_Smoke() = default; public:
...
public:
	static CEffect_Boss_Missile_Smoke* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pDeviceContext, void* pArg);
