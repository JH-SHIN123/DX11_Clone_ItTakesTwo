...
BEGIN(Client)
class CEffect_Boss_Missile_Smoke_Black final: public CInGameEffect
{
private:
	explicit CEffect_Boss_Missile_Smoke_Black(ID3D11Device* pDevice, ID3D11DeviceContext* pDeviceContext);
	explicit CEffect_Boss_Missile_Smoke_Black(const CEffect_Boss_Missile_Smoke_Black& rhs);
	virtual ~CEffect_Boss_Missile_Smoke_Black() = default; public:
