...
BEGIN(Client)
class CEffect_Boss_Core_Explosion final : public CInGameEffect
{
private:
	explicit CEffect_Boss_Core_Explosion(ID3D11Device* pDevice, ID3D11DeviceContext* pDeviceContext);
	explicit CEffect_Boss_Core_Explosion(const CEffect_Boss_Core_Explosion& rhs);
	virtual ~CEffect_Boss_Core_Explosion() = default; public:
