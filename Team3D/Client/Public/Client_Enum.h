...
{
	enum TRIGGER {
		InputButton_Dot, InputButton_InterActive, InputButton_InterActive_Rail,InputButton_PS_InterActive, InputButton_OK, InputButton_PS_OK, PC_Mouse_Reduction,
		PC_Mouse_Enlargement, InputButton_Cancle, InputButton_PS_Cancle, InputButton_Up, InputButton_Down, InputButton_PS_Up, Minigame_Ready_Cody, Minigame_Ready_May,
		...
		HeaderBox_2p_Ready /*Default */, LoadingScreen /* Default */, Minigame_Countdown /* Default */, TRIGGER_END
	};

	enum INTERACTIVE_ID {
		ControlRoom_Battery, StarBuddy, PinBall_Door, PinBall_Handle, TutorialDoor, Umbrella_Joystick, SpaceValve, SpaceRail, HookUFO, INTERACTIVE_ID_END
	};
