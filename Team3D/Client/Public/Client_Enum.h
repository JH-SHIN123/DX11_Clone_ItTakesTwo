...
namespace UI
{
	enum TRIGGER {
		...
		RespawnCircle_Cody, RespawnCircle_May, InputButton_InterActive_F, InputButton_InterActive_HookUFO, InputButton_PS_InterActive_HookUFO, MenuScreen, AlphaScreen, SwingPoint, WhiteScreenFadeInOut, BlackScreenFadeInOut, CutSceneBar, Minigame_Win_May /*Default */,
