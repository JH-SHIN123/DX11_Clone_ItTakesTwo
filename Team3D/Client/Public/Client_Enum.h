...
namespace UI
{
	enum TRIGGER {
		...
		StickIcon, Portrait_Cody, Portrait_May, RespawnCircle, MenuScreen, AlphaScreen, SwingPoint, WhiteScreenFadeInOut, BlackScreenFadeOut, CutSceneBar, LoadingBook /*Default */, ControllerIcon_KeyBoard /*Default */,
	...
	enum INTERACTIVE_ID {
		ControlRoom_Battery, StarBuddy, PinBall_Door, PinBall_Handle, TutorialDoor, Umbrella_Joystick, SpaceValve, SpaceRail, HookUFO, PowerCoord, INTERACTIVE_ID_END
	};
