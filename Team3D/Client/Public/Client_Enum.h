...
namespace UI
{
	enum TRIGGER {
		...
		RespawnCircle_Cody, RespawnCircle_May, InputButton_InterActive_F, MenuScreen, AlphaScreen, SwingPoint, WhiteScreenFadeInOut, BlackScreenFadeInOut, CutSceneBar, Minigame_Win_May /*Default */,
