...
class CEffect_Pinball_Explosion_Particle final : public CInGameEffect
{
private:
	explicit CEffect_Pinball_Explosion_Particle(ID3D11Device* pDevice, ID3D11DeviceContext* pDeviceContext);
	explicit CEffect_Pinball_Explosion_Particle(const CEffect_Pinball_Explosion_Particle& rhs);
	virtual ~CEffect_Pinball_Explosion_Particle() = default; public:
...
public:
	static CEffect_Pinball_Explosion_Particle* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pDeviceContext, void* pArg);
