...
class CEffect_Player_Rail_Smoke final : public CInGameEffect
{
private:
	explicit CEffect_Player_Rail_Smoke(ID3D11Device* pDevice, ID3D11DeviceContext* pDeviceContext);
	explicit CEffect_Player_Rail_Smoke(const CEffect_Player_Rail_Smoke& rhs);
	virtual ~CEffect_Player_Rail_Smoke() = default; public:
...
public:
	static CEffect_Player_Rail_Smoke* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pDeviceContext, void* pArg);
