...
BEGIN(Client)
class CElectricBox final : public CDynamic_Env
{
private:
	explicit CElectricBox(ID3D11Device* pDevice, ID3D11DeviceContext* pDeviceContext);
...
public:
	static CElectricBox* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pDeviceContext);
