...
BEGIN(Client) 
class CEffect_Env_Particle : public CInGameEffect
{
public:
...
public:
	...
	void	Set_ParentMatrix(_fmatrix ParentMatrix, _fvector vOffSetPos = XMVectorZero());
