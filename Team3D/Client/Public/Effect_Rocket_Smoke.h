...
BEGIN(Client)
class CEffect_Rocket_Smoke final : public CInGameEffect
{
private:
	explicit CEffect_Rocket_Smoke(ID3D11Device* pDevice, ID3D11DeviceContext* pDeviceContext);
	explicit CEffect_Rocket_Smoke(const CEffect_Rocket_Smoke& rhs);
	virtual ~CEffect_Rocket_Smoke() = default; public:
...
public:
	static CEffect_Rocket_Smoke* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pDeviceContext, void* pArg);
