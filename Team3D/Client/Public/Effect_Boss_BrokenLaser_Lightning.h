...
class CEffect_Boss_BrokenLaser_Lightning final : public CInGameEffect
{
private:
	explicit CEffect_Boss_BrokenLaser_Lightning(ID3D11Device* pDevice, ID3D11DeviceContext* pDeviceContext);
	explicit CEffect_Boss_BrokenLaser_Lightning(const CEffect_Boss_BrokenLaser_Lightning& rhs);
	virtual ~CEffect_Boss_BrokenLaser_Lightning() = default; public:
