...
BEGIN(Client)
class CEffect_MoonBaboon_Booster final : public CInGameEffect
{
private:
	explicit CEffect_MoonBaboon_Booster(ID3D11Device* pDevice, ID3D11DeviceContext* pDeviceContext);
	explicit CEffect_MoonBaboon_Booster(const CEffect_MoonBaboon_Booster& rhs);
	virtual ~CEffect_MoonBaboon_Booster() = default; public:
...
public:
	static CEffect_MoonBaboon_Booster* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pDeviceContext, void* pArg);
