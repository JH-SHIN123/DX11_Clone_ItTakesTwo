...
PS_OUT	PS_GRAVITYPATH(PS_IN In)
{
	PS_OUT Out = (PS_OUT)0;
...
technique11 DefaultTechnique
{
	...
	pass GravityPath
	{
		...
		PixelShader		= compile ps_5_0 PS_GRAVITYPATH();
	}
};