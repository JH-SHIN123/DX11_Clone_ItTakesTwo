...
HRESULT CHDR::PostProcessing(_double TimeDelta)
{
...
HRESULT CHDR::DownScale(_double TimeDelta)
{
...
HRESULT CHDR::Build_LuminanceBuffer(_float iWidth, _float iHeight)
{
