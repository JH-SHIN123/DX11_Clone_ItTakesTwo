...
CVIBuffer_PointInstance_Custom_ST::CVIBuffer_PointInstance_Custom_ST(ID3D11Device * pDevice, ID3D11DeviceContext * pDeviceContext)
	: CVIBuffer(pDevice, pDeviceContext)
{
}

CVIBuffer_PointInstance_Custom_ST::CVIBuffer_PointInstance_Custom_ST(const CVIBuffer_PointInstance_Custom_ST & rhs)
	: CVIBuffer(rhs)
...
HRESULT CVIBuffer_PointInstance_Custom_ST::NativeConstruct_Prototype(_uint iMaxInstanceCount, const _tchar * pShaderFilePath, const char * pTechniqueName)
{
...
HRESULT CVIBuffer_PointInstance_Custom_ST::NativeConstruct(void * pArg)
{
...
HRESULT CVIBuffer_PointInstance_Custom_ST::Render(_uint iPassIndex)
{
	MSG_BOX("Wrong Access - CVIBuffer_PointInstance_Custom_ST");

	return S_OK;
}

HRESULT CVIBuffer_PointInstance_Custom_ST::Render(_uint iPassIndex, void * VertexMatrices, _uint iInstanceCount, _uint iStartIndex)
{
...
HRESULT CVIBuffer_PointInstance_Custom_ST::Set_DefaultVariables()
{
...
CVIBuffer_PointInstance_Custom_ST * CVIBuffer_PointInstance_Custom_ST::Create(ID3D11Device * pDevice, ID3D11DeviceContext * pDeviceContext, _uint iMaxInstanceCount, const _tchar * pShaderFilePath, const char * pTechniqueName)
{
	CVIBuffer_PointInstance_Custom_ST* pInstance = new CVIBuffer_PointInstance_Custom_ST(pDevice, pDeviceContext);

	if (FAILED(pInstance->NativeConstruct_Prototype(iMaxInstanceCount, pShaderFilePath, pTechniqueName)))
	{
		MSG_BOX("Failed to Create Instance - CVIBuffer_PointInstance_Custom_ST");
...
CComponent * CVIBuffer_PointInstance_Custom_ST::Clone_Component(void * pArg)
{
	CVIBuffer_PointInstance_Custom_ST* pInstance = new CVIBuffer_PointInstance_Custom_ST(*this);

	if (FAILED(pInstance->NativeConstruct(pArg)))
	{
		MSG_BOX("Failed to Clone Instance - CVIBuffer_PointInstance_Custom_ST");
		Safe_Release(pInstance);
	}
...
void CVIBuffer_PointInstance_Custom_ST::Free()
{
	if (false == m_isClone)
