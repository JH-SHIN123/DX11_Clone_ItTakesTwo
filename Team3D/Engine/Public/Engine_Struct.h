...
namespace Engine
{
	...
	{
		enum Enum { 
			RENDER_PRIORITY, RENDER_NONALPHA, RENDER_VOLUME, RENDER_ALPHA, 
			RENDER_EFFECT_PRE_CUSTOM_BLUR, RENDER_EFFECT, RENDER_EFFECT_POST_CUSTOM_BLUR, RENDER_EFFECT_NO_BLUR,
