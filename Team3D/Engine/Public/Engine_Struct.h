...
namespace Engine
{
	...
	{
		enum Enum { 
			RENDER_PRIORITY, RENDER_NONALPHA, RENDER_VOLUME, RENDER_ALPHA, RENDER_EFFECT, RENDER_EFFECT_NO_BLUR /*RENDER_AFTERPOST_NONBLUR*/, RENDER_AFTERPOST_BLUR, RENDER_UI, RENDER_END,
			/* Sub Groups */
