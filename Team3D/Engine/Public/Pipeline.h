...
public: /* Enum */
	enum TRANSFORM_STATETYPE { 
		TS_MAINVIEW, TS_MAINVIEW_INVERSE, TS_MAINPROJ, TS_MAINPROJ_INVERSE, TS_MAINPROJ_FOR_EARTH,
		TS_SUBVIEW, TS_SUBVIEW_INVERSE, TS_SUBPROJ, TS_SUBPROJ_INVERSE, TS_SUBPROJ_FOR_EARTH,
