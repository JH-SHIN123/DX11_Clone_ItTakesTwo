...
#pragma region General_Character
	...
	CHANNEL_MOONUFO_LASER, CHANNEL_MOONUFO_MOVE, CHANNEL_MOONUFO_MOVE_END, CHANNEL_MOONUFO_MOVE_START, CHANNEL_MOONUFO_SEARCH1, CHANNEL_MOONUFO_SEARCH2, CHANNEL_MOONUFO_SEARCH3,
#pragma endregion
...
#pragma endregion
	...
	/* Jin */
	, CHANNEL_BOSS_UFO
	, CHANNEL_BOSS_MOONBABOON
	, CHANNEL_BOSS_EFFECT
	, CHANNEL_PIPE
	, CHANNEL_PIPEEFFECT
	, CHANNEL_UMBRELLABEAM
	, CHANNEL_UMBRELLABEAMEFFECT
	, CHANNEL_BOSSCORE
	, CHANNEL_BOSSMISSILE_CODY
	, CHANNEL_BOSSMISSILE_MAY
	, CHANNEL_BOSSLASER
	/* Hye */
	, CHANNEL_LOGO
	, CHANNEL_BUTTON
	...
	, CHANNEL_VOICE
	, CHANNEL_INUFO_PEDAL
	, CHANNEL_INUFO_ROTATEBOX
	, CHANNEL_INUFO_WALLPRESS
	, CHANNEL_INUFO_ELECTRICBOX
	/* Jung */
	, CHANNEL_FIRE_DOOR
